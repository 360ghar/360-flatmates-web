...
// from `useSwipeDeck`. It is mirrored here so animation effects can mutate it
// without going through the React tree. The proper refactor is to derive `cardQueue` from
